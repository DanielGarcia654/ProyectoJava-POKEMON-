...
public class tipoFuego extends Pokemon{
    ...
    * @param type Obtener el tipo de pokemon
     */
    public tipoFuego(String name, int health, int attackDamage, int defence, int speed, int state, String type) {
    ...
    public float setElementalMultiplier(Player jugador, String enemyType){
        ...
        if ("Hierba".equals(enemyType)){
            System.out.println("¡¡¡Ataque super efectivo!!!");
            return elementalMultiplier = (float) 2.0;
        }
        
        if ("Fuego".equals(enemyType) || "Agua".equals(enemyType) || "Roca".equals(enemyType)){
